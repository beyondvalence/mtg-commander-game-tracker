...
const games = [
  { id: '1', playedAt: '2026-01-01', playersCount: 2, winCondition: 'Combat', participants: [{ seat:1, playerName:'A', primary:{scryfallId:'x',name:'Atraxa'}, isWinner:true }, { seat:2, playerName:'B', primary:{scryfallId:'y',name:'Kraum'} }] },
  { id: '2', playedAt: '2026-01-02', playersCount: 2, winCondition: 'Combo', participants: [{ seat:1, playerName:'A', primary:{scryfallId:'y',name:'Kraum'}, secondary:{scryfallId:'z',name:'Tymna'}, isWinner:true }, { seat:2, playerName:'B', primary:{scryfallId:'x',name:'Atraxa'} }] }
] as any;
