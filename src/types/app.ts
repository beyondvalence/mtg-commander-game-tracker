...
export type GameRecord = { id: string; userId: string; playedAt: string; durationMinutes?: number | null; playersCount: number; winCondition: string; notes?: string; participants: ParticipantInput[] };
