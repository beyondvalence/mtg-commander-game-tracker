...
export type GameRecord = { id: string; title?: string | null; playedAt: string; durationMinutes?: number | null; playersCount: number; winCondition: string; notes?: string; participants: ParticipantInput[] };
