...
export type GameRecord = { id: string; title?: string | null; playedAt: string; durationMinutes?: number | null; playersCount: number; bracket: number; winCondition: string; notes?: string; participants: ParticipantInput[] };
